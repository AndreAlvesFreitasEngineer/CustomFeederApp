package com.example.korberconsumer.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "korber-consumer-1");
    ...
    /**
     * Configures the listener container factory for parallel consumption.
     *
